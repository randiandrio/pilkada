...
function Delete({ slide, reload }: { slide: Slide; reload: Function }) {
  ...
  const handleDelete = async () => {
    ...
    fileData.append("filename", slide.gambar);
    await axios.post(urlHapusGambar, fileData);
    const formData = new FormData();
    formData.append("id", String(slide.id));
    await axios.patch("/slide/api/delete", formData);
    reload();
    setPost(false);
    Swal.fire({
      title: "Success!",
