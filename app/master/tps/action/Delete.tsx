...
function Delete({ tps, reload }: { tps: Tps; reload: Function }) {
  ...
  if (isPost) {
    Swal.fire({
      title: "Mohon tunggu",
      html: "Sedang menghapus data TPS",
  ...
  const handleDelete = async () => {
    ...
    formData.append("id", String(tps.id));
    await axios.patch("/master/tps/api/delete", formData);
    reload();
    setPost(false);
    Swal.fire({
      title: "Success!",
